...
//
{
    ...
    //
    {
        ...
        // ASSIGNMENT (PA06)
        //
        // Add code here to return the face index. Remember that iff
        // `wrapI` is true, the faces (nI, j, 0) and (nI, j, 1) have
        // normals (and require face indices) and that iff `wrapJ` is
        // true, the faces (i, nJ, 0) and (i, nJ, 1) have normals
        // (and likewise require face indices). Examine the first
        // "assert()" above to see the kind of reasoning you need to
        // make.
        //
        // 1 lines in instructor solution (YMMV)
        //
