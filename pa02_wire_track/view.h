...
//
{
    ...
    static const int defaultCanvasWidth  = 700,
                     defaultCanvasHeight = 700; // of drawing area, in pixels
...
View(void)
    ...
    const void renderSupertext(double xFrac, double yFrac, string lines[],
                               int nLines) const;
    void reset(void);
