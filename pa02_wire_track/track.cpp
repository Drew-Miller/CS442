...
{
    scene->uniformColorShaderProgram->setColor(whiteColor);
...
Track::Track(void)
{
    ...
    trackTrigonometricCurve = new TrigonmetricCurve(mag, freq, phase, offset, nRailSegments);

    double support = 1.0 / nSupports;
